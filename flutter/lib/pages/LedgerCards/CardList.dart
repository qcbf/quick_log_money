...
class _CardListState extends State<CardList> {
  ...
  void initState() {
    UserDB.managers.userCards.filter((f) => f.Uid(User.Info.Id) & f.Place(widget.Space)).get().then((value) => setState(() => Cards = [
          ...value,
          UserCard(Id: 1, Uid: User.Info.Id, Place: ELedgerCardSpace.Home, Name: "RecentDays"),
          UserCard(Id: 1, Uid: User.Info.Id, Place: ELedgerCardSpace.Home, Name: "EveryDayEntries"),
          UserCard(Id: 1, Uid: User.Info.Id, Place: ELedgerCardSpace.Home, Name: "Month"),
        ]));
    super.initState();
  }
