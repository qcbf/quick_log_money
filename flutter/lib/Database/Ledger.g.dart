...
class LedgerTag extends DataClass implements Insertable<LedgerTag> {
  final int Id;
  final String Name;
  const LedgerTag({required this.Id, required this.Name});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(Id);
  ...
  LedgerTag copyWith({int? Id, String? Name}) => LedgerTag(
        Id: Id ?? this.Id,
        Name: Name ?? this.Name,
      );
  @override
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is LedgerTag && other.Id == this.Id && other.Name == this.Name);
}
...
class LedgerTagsCompanion extends UpdateCompanion<LedgerTag> {
  ...
  LedgerTagsCompanion copyWith({Value<int>? Id, Value<String>? Name}) {
    return LedgerTagsCompanion(
      Id: Id ?? this.Id,
      Name: Name ?? this.Name,
    );
...
abstract class _$LedgerDatabaseConnector extends GeneratedDatabase {
  _$LedgerDatabaseConnector(QueryExecutor e) : super(e);
  _$LedgerDatabaseConnectorManager get managers =>
      _$LedgerDatabaseConnectorManager(this);
  ...
  late final Index entryTagId = Index(
      'Entry.TagId', 'CREATE INDEX "Entry.TagId" ON ledger_entries (tag_id)');
  late final Index entryDate =
      Index('Entry.Date', 'CREATE INDEX "Entry.Date" ON ledger_entries (date)');
  late final Index ownerUserId = Index(
      'Owner.UserId', 'CREATE INDEX "Owner.UserId" ON ledger_owners (user_id)');
  @override
...
class $$LedgerInfosTableTableManager extends RootTableManager<
  ...
  $$LedgerInfosTableTableManager(
      _$LedgerDatabaseConnector db, $LedgerInfosTable table)
...
class $$LedgerInfosTableFilterComposer
    extends FilterComposer<_$LedgerDatabaseConnector, $LedgerInfosTable> {
...
class $$LedgerInfosTableOrderingComposer
    extends OrderingComposer<_$LedgerDatabaseConnector, $LedgerInfosTable> {
...
class $$LedgerEntriesTableTableManager extends RootTableManager<
  ...
  $$LedgerEntriesTableTableManager(
      _$LedgerDatabaseConnector db, $LedgerEntriesTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          filteringComposer:
...
class $$LedgerEntriesTableFilterComposer
    extends FilterComposer<_$LedgerDatabaseConnector, $LedgerEntriesTable> {
...
class $$LedgerEntriesTableOrderingComposer
    extends OrderingComposer<_$LedgerDatabaseConnector, $LedgerEntriesTable> {
...
class $$LedgerTagsTableTableManager extends RootTableManager<
  ...
  $$LedgerTagsTableTableManager(
      _$LedgerDatabaseConnector db, $LedgerTagsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          filteringComposer:
...
class $$LedgerTagsTableFilterComposer
    extends FilterComposer<_$LedgerDatabaseConnector, $LedgerTagsTable> {
...
class $$LedgerTagsTableOrderingComposer
    extends OrderingComposer<_$LedgerDatabaseConnector, $LedgerTagsTable> {
...
class $$LedgerRecentTagsTableTableManager extends RootTableManager<
  ...
  $$LedgerRecentTagsTableTableManager(
      _$LedgerDatabaseConnector db, $LedgerRecentTagsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          filteringComposer:
...
class $$LedgerRecentTagsTableFilterComposer
    extends FilterComposer<_$LedgerDatabaseConnector, $LedgerRecentTagsTable> {
...
class $$LedgerRecentTagsTableOrderingComposer extends OrderingComposer<
    _$LedgerDatabaseConnector, $LedgerRecentTagsTable> {
...
class $$LedgerOwnersTableTableManager extends RootTableManager<
  ...
  $$LedgerOwnersTableTableManager(
      _$LedgerDatabaseConnector db, $LedgerOwnersTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          filteringComposer:
...
class $$LedgerOwnersTableFilterComposer
    extends FilterComposer<_$LedgerDatabaseConnector, $LedgerOwnersTable> {
...
class $$LedgerOwnersTableOrderingComposer
    extends OrderingComposer<_$LedgerDatabaseConnector, $LedgerOwnersTable> {
...
class _$LedgerDatabaseConnectorManager {
  final _$LedgerDatabaseConnector _db;
  _$LedgerDatabaseConnectorManager(this._db);
